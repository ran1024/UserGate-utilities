<h3>Экспорт/импорт конфигурации UTM UserGate (Версия 2.12)</h3>
...
<b>Версия 4973 не предназначена для работы. Она предназначена только для экспорта конфигурации и последующего
немедленного перехода на версию 6.</b>
